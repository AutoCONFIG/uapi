...
const geminiCodeModels = "gemini-2.5-pro,gemini-2.5-flash,gemini-2.5-flash-lite,gemini-3-pro-preview,gemini-3.1-pro-preview,gemini-3-flash-preview,gemini-3.1-flash-lite-preview";
...
const antigravityModels = "gemini-3.5-flash,gemini-3.1-pro,claude-sonnet-4-6,claude-opus-4-6-thinking,gpt-oss-120b,nano-banana-2";
