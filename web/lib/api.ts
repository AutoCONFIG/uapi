...
export const adminApi = {
  ...
  createPlan: (token: string, body: { name: string; type: string; policy_id?: string; model_ratios?: string; completion_ratio?: string; duration_days?: number; enabled?: boolean }) =>
    request<Plan>("/api/admin/plans", { method: "POST", token, body }),
  updatePlan: (token: string, id: string, body: Partial<{ name: string; type: string; policy_id: string; model_ratios: string; completion_ratio: string; duration_days: number; enabled: boolean }>) =>
