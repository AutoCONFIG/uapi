...
> [!NOTE]
> **Note:** Computer use is not currently supported by the Gemini 3.5 Flash model. See [Model versions](https://ai.google.dev/gemini-api/docs/interactions/computer-use#model-versions) section for a list of supported models.
