...
Initiating an interaction with a thinking model is similar to any other interaction request. Specify one of the [models with thinking support](https://ai.google.dev/gemini-api/docs/interactions/thinking#thinking-levels) in the `model` field:
