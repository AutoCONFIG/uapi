...
- [**Static webhooks**](https://ai.google.dev/gemini-api/docs/interactions/webhooks#static-webhooks): Project-level endpoints configured with the Gemini [WebhookService API](https://ai.google.dev/api). Good for global integrations (e.g., notifying Slack, syncing a database, etc.).
- [**Dynamic webhooks**](https://ai.google.dev/gemini-api/docs/interactions/webhooks#dynamic-webhooks): Request-level overrides passing a webhook URL in the configuration payload of a specific jobs call. Ideal for routing specific jobs to dedicated endpoints.
...
[rotate](https://ai.google.dev/gemini-api/docs/interactions/webhooks#rotate-signing-secret) it.
...
[Handle webhook requests](https://ai.google.dev/gemini-api/docs/interactions/webhooks#handle-webhook-requests) section.
...
signatures and your stored static signing secret. See the [Webhook envelope](https://ai.google.dev/gemini-api/docs/interactions/webhooks#webhook-envelope) section for the payload information.
