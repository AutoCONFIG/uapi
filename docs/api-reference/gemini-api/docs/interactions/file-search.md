...
[pricing](https://ai.google.dev/gemini-api/docs/interactions/file-search#pricing) section for details.
...
[Directly upload to File Search store](https://ai.google.dev/gemini-api/docs/interactions/file-search#upload) or [Importing files](https://ai.google.dev/gemini-api/docs/interactions/file-search#importing-files).
