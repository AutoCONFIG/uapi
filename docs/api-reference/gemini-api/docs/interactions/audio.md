...
- [Upload an audio file](https://ai.google.dev/gemini-api/docs/interactions/audio#upload-audio) before making a request.
- [Pass inline audio data](https://ai.google.dev/gemini-api/docs/interactions/audio#inline-audio) with the request.
...
\* For reuse, [upload the file](https://ai.google.dev/gemini-api/docs/interactions/audio#upload-audio) instead
...
- [System instructions](https://ai.google.dev/gemini-api/docs/interactions/text-generation#system-instructions): Customize model behavior
- [Structured output](https://ai.google.dev/gemini-api/docs/interactions/structured-output): Get transcription results in JSON format