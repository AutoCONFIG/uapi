...
- [Setting your API key as an environment variable](https://ai.google.dev/gemini-api/docs/interactions/api-key#set-api-env-var)
- [Providing your API key explicitly](https://ai.google.dev/gemini-api/docs/interactions/api-key#provide-api-key-explicitly)
...
key in [Providing API key explicitly](https://ai.google.dev/gemini-api/docs/interactions/api-key#provide-api-key-explicitly) section.
...
API. Refer to the [import projects](https://ai.google.dev/gemini-api/docs/interactions/api-key#import-projects) section for instructions.
