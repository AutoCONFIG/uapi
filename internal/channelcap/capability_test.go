...
func TestChatGPTReverseSupportsOnlyPlainChat(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "images", req: Request{Kind: KindChatCompletion, HasImages: true}, want: false},
		{name: "responses", req: Request{Kind: KindResponses}, want: false},
